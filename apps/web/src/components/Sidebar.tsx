                ...
                >
                  ...
                  >
                    ...
                    {scopedProjectGroups.length > 1 ? (
                      <span
                        aria-hidden="true"
                        className="pointer-events-none absolute top-0 right-0 flex h-3.5 min-w-3.5 items-center justify-center rounded-full bg-foreground px-0.5 font-semibold text-[9px] text-background tabular-nums"
                      >
